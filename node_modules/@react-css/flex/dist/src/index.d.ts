...
export type ContainerTags = Pick<JSX.IntrinsicElements, 'div' | 'nav' | 'main' | 'aside' | 'article' | 'header' | 'section' | 'footer'>;
type TagName = {
...
export type FlexContainerProps<ContainerType = HTMLDivElement> = ContainerProps<ContainerType> & DisplayCSS & FlexDirectionCSS & FlexWrapCSS & JustifyContentCSS & AlignItemsCSS & AlignContentCSS & FlexFlowCSS & GapCSS & RowGapCSS & ColumnGapCSS & TagName;
export type FlexItemProps<ContainerType = HTMLDivElement> = ContainerProps<ContainerType> & OrderCSS & FlexGrowCSS & FlexShrinkCSS & FlexBasisCSS & FlexCSS & AlignSelfCSS & TagName;
export {};
